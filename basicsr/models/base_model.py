...
class BaseModel():
            ...
            for optimizer in self.optimizers:
                self.schedulers.append(
                    lr_scheduler.MultiStepRestartLR(optimizer,
                                                    args.scheduler_periods, args.scheduler_restart_weights, args.scheduler_eta_mins))
        elif scheduler_type == 'CosineAnnealingRestartLR':
            for optimizer in self.optimizers:
                self.schedulers.append(
                    lr_scheduler.CosineAnnealingRestartLR(
                        optimizer, #**train_opt['scheduler']))
                        args.scheduelr_periods, args.scheduler_restart_weights, args.scheduler_eta_mins))
    ...
    def save_network(self, net, net_label, current_iter, param_key='params'):
        ...
        save_path = os.path.join(args.checkpoint_save_dir, save_filename)
    ...
    def save_best_network(self, net, net_label, current_iter, param_key='params'):
        """Save networks.
    ...
    def save_training_state(self, epoch, current_iter):
        ...
        if current_iter != -1:
            ...
            #                          save_filename)
            save_path = os.path.join(args.training_states_path,
                                     save_filename)
